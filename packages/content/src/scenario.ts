...
export const soloScenario = scenarioDefinitionSchema.parse({
  ...
  events: [
    ...
    { id: "airlift-extension", title: "Airlift extension agreement", summary: "Sustained alliance and program investment yields a partner airlift extension, improving theater movement options.", minTurn: 4, maxTurn: 10, triggerTags: ["alliance", "program"], requiredFlags: ["partner_relief"], excludedFlags: ["coalition_fractured"], setsFlags: ["airlift_extended"], clearsFlags: [], stateDelta: { sustainment: { liftAvailability: 6 }, alliance: { partnerParticipation: 2, reassurance: 3 } }, constraintShifts: [{ constraintId: "shipping-market", delta: -6 }] },
    { id: "alliance-signaling-backfire", title: "Alliance signaling backfire", summary: "Public deterrence commitments draw adversary attention; probe tempo rises in response.", minTurn: 3, maxTurn: 9, triggerTags: ["public-commitment", "deterrence"], requiredFlags: [], excludedFlags: ["deterrence_signaled"], setsFlags: ["signaling_backfire"], clearsFlags: [], stateDelta: { escalation: { probeTempo: 5, incidentLadder: 3, crisisSensitivity: 2 }, domestic: { mediaHeat: 3 } }, constraintShifts: [] },
    // ── Intelligence arc (continued) ──────────────────────────────────────────
    { id: "industrial-espionage-probe", title: "Industrial espionage probe", summary: "Adversary intelligence operation attempts to penetrate defense industry supply chains after Allied collection activities draw attention.", minTurn: 3, maxTurn: 9, triggerTags: ["industrial-watch", "collection"], requiredFlags: [], excludedFlags: ["counter_deception_mature"], setsFlags: ["industrial_probe"], clearsFlags: [], stateDelta: { intelligence: { deceptionPressure: 6, confidence: -3 }, sustainment: { depotBacklog: 3 } }, constraintShifts: [{ constraintId: "electronics-chain", delta: 6 }] },
    { id: "fires-integration-window", title: "Fires integration window", summary: "A realistic exercise window opens for fires integration, rewarding the simulation investment with measurable operational learning.", minTurn: 3, maxTurn: 9, triggerTags: ["fires", "simulation"], requiredFlags: [], excludedFlags: ["electronics_disrupted"], setsFlags: ["fires_demonstrated"], clearsFlags: [], stateDelta: { forceGeneration: { trainingThroughput: 4 }, escalation: { incidentLadder: -3 }, alliance: { reassurance: 2 } }, constraintShifts: [] },
    // ── Personnel arc (continued) ─────────────────────────────────────────────
    { id: "reserve-recall-success", title: "Reserve recall success", summary: "Disciplined recovery investment pays off as an unplanned partial mobilisation completes well ahead of schedule.", minTurn: 4, maxTurn: 10, triggerTags: ["recovery", "retention"], requiredFlags: [], excludedFlags: ["reserve_backlash", "retention_crisis"], setsFlags: ["reserve_reconstituted"], clearsFlags: [], stateDelta: { forceGeneration: { deployableUnits: 0.7, reserveStrain: -4, personnelShortfalls: -3 } }, constraintShifts: [] },
    // ── Domestic arc (continued) ──────────────────────────────────────────────
    { id: "media-scrutiny-gap", title: "Media scrutiny gap", summary: "Press coverage exposes the gap between public deterrence rhetoric and actual available readiness, forcing a quiet correction.", minTurn: 4, maxTurn: 10, triggerTags: ["deterrence", "public-commitment"], requiredFlags: ["scrutiny_cycle"], excludedFlags: ["cabinet_crisis"], setsFlags: ["media_scrutiny"], clearsFlags: [], stateDelta: { domestic: { cabinetCover: -4, mediaHeat: 6, publicPatience: -2 }, alliance: { politicalAlignment: -2 } }, constraintShifts: [] },
  ],
  initialState: {
    turn: 1,
    maxTurns: 12,
