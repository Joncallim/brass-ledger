...
// Dialogue is authored content, not a simulation switchboard. These contracts make the
// six command voices audibly different while the shared renderer supplies live facts.
const dialogue = (profile: unknown) => chiefDialogueProfileSchema.parse(profile);
const chiefDialogues = {
  warden: dialogue({ cadence: "plain, concrete, often names who pays", argumentMode: "human cost and durable readiness", pressureResponse: "counts families, reserve employers, and recovery days", disagreementStyle: "protective refusal", trustPositiveTell: "lets the force carry a hard month when the recovery plan is explicit", trustNegativeTell: "stops accepting that endurance is a plan", unpromptedSubjects: ["retention", "recovery", "reserve employers"], reservedPhrases: ["people do not regenerate on a slide", "a force can obey while becoming brittle"], forbiddenPhrases: ["clean packet"], opener: ["I have counted who will absorb this after the briefing ends.", "Before we call this tempo, say whose recovery time we are spending."], cooperative: ["Protect experience and I can keep the force with you.", "Put recovery in the order, not in an apology afterward."], skeptical: ["People do not regenerate on a slide.", "A force can obey while becoming brittle."], confrontational: ["Do not turn family tolerance into an unpriced reserve account.", "If this spends the same people again, call it a choice, not resilience."], closer: ["Name the recovery boundary and my office will carry it.", "Give the force a survivable rhythm and I will defend the order."] }),
  halden: dialogue({ cadence: "spare, forensic, separates observation from inference", argumentMode: "evidence and uncertainty", pressureResponse: "marks the estimate's weakest source", disagreementStyle: "withholds certification rather than dramatizing", trustPositiveTell: "shares confidence bounds before anyone asks", trustNegativeTell: "starts distinguishing what is known from what the room wants known", unpromptedSubjects: ["source confidence", "deception", "warning time"], reservedPhrases: ["observation is not inference", "certainty has to be earned twice"], forbiddenPhrases: ["carry the room"], opener: ["The estimate has an edge; I would rather show it than sand it off.", "There is a fact here, an inference, and a hope. They are not interchangeable."], cooperative: ["Keep the confidence bounds visible and I can defend the estimate.", "Give me a narrow claim and I will make it useful."], skeptical: ["Observation is not inference.", "Certainty has to be earned twice: once by collection and once by challenge."], confrontational: ["Do not ask intelligence to notarize a preference.", "If the signal is theatrical, it is not evidence."], closer: ["Record the uncertainty and I will stand behind the warning.", "Bound the claim; the picture remains usable."] }),
  briggs: dialogue({ cadence: "short, active, field-first", argumentMode: "executable tempo and deterrent effect", pressureResponse: "tests whether an order survives contact", disagreementStyle: "direct challenge", trustPositiveTell: "offers a concrete first move", trustNegativeTell: "calls delay a decision with consequences", unpromptedSubjects: ["first contact", "posture", "time"], reservedPhrases: ["the field gets a vote", "an order has to survive contact"], forbiddenPhrases: ["coherent story"], opener: ["The field gets a vote on this, and it will not read the briefing notes.", "An order has to survive contact, not merely committee."], cooperative: ["Give me an executable first move and I will make it matter.", "If the force can act on it this week, operations can carry it."], skeptical: ["Tempo is not a graphic on a slide.", "If this stops at posture language, the other side sees through it."], confrontational: ["Do not signal resolve with an order too timid to execute.", "Delay is a choice; say what it gives the adversary."], closer: ["Set the first move and I will put weight behind it.", "Give operations a real order, not a promise."] }),
  okafor: dialogue({ cadence: "methodical, physical, uses constraints as nouns", argumentMode: "supportability and sequencing", pressureResponse: "traces promises to lift, spares, and depot slots", disagreementStyle: "calm accounting", trustPositiveTell: "offers the buffer and its price", trustNegativeTell: "asks which physical input the order intends to consume", unpromptedSubjects: ["lift", "repair slots", "buffers"], reservedPhrases: ["the depot is part of the decision", "nothing moves on optimism"], forbiddenPhrases: ["sharp effect"], opener: ["The depot is part of the decision, whether the room admits it or not.", "Nothing moves on optimism; it moves on lift, fuel, and repair time."], cooperative: ["State the physical boundary and I can make the support plan real.", "Spend the buffer consciously and I can sequence it."], skeptical: ["A promise without a support tail is only a future shortage.", "The bottleneck will choose itself if we do not choose it first."], confrontational: ["Do not invoice sustainment after the order has already left the room.", "If you want activity without inputs, you are ordering fiction."], closer: ["Name the load and I will keep it moving.", "Keep the promise supportable and I can stand behind it."] }),
  sato: dialogue({ cadence: "measured, audience-aware, looks two decisions ahead", argumentMode: "political feasibility and strategic sequence", pressureResponse: "maps who hears the order and what they infer", disagreementStyle: "reframes rather than vetoes", trustPositiveTell: "offers a sequence that preserves room", trustNegativeTell: "asks which audience is being knowingly disappointed", unpromptedSubjects: ["allies", "cabinet", "next month"], reservedPhrases: ["every audience receives an order", "room is a resource"], forbiddenPhrases: ["first contact"], opener: ["Every audience receives an order, not just the force.", "Room is a resource; this choice spends or creates it."], cooperative: ["Keep one line for allies, cabinet, and the force, and I can widen room.", "Sequence the move and I can preserve the next decision."], skeptical: ["A message that outruns means becomes a liability.", "The coalition remembers the gap between language and delivery."], confrontational: ["Choose the audience you are prepared to disappoint before you choose the headline.", "Strategy is not what we announce; it is what still holds next month."], closer: ["Give me a sequenced order and I can keep the coalition aligned.", "Keep the line credible and I can buy room for the next turn."] }),
  navarro: dialogue({ cadence: "precise, repetitive, contemptuous of paper readiness", argumentMode: "repetition, standards, and absorption", pressureResponse: "asks what can be practiced twice", disagreementStyle: "insists on demonstrable standards", trustPositiveTell: "turns a narrow order into a repeatable drill", trustNegativeTell: "separates certification from competence", unpromptedSubjects: ["repetition", "instructors", "standards"], reservedPhrases: ["repetition is the receipt", "certification is not competence"], forbiddenPhrases: ["coalition line"], opener: ["Repetition is the receipt. Until then, this is an intention.", "Certification is not competence, and the force knows the difference."], cooperative: ["Give me a standard we can repeat and I will make it stick.", "Protect instructor time and I can turn intent into capability."], skeptical: ["The force learns at the speed it can practice, not the speed we announce.", "A single clean run is not a capability."], confrontational: ["Do not ask training to certify impatience.", "If we cannot repeat it under pressure, we have not built it."], closer: ["Set the standard and I will build the repetitions.", "Narrow it enough to practice and training can carry it."] }),
};
