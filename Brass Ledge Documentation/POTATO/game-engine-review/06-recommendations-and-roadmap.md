...
The S1-S5 core mechanic and Stage 3 tech/industry model are implemented and covered by engine tests. The active engine pass is Stage 4: agent chiefs and negotiation.
...
4. Let the player negotiate staff constraints before committing a turn. Started: `TurnInput.staffNegotiations` applies bounded relief to a chosen directorate before resolution and charges an explicit political, readiness, or budget cost.
