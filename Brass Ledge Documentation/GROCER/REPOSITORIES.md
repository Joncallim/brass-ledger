...
This workspace is the GROCER vault. It uses four internal documentation domains. Each domain has a different job and should not become a dumping ground for the others.
