...
Execute PR #111 as **one continuous goal-driven pass**. Intermediate commits, partial milestones, structural consolidations, focused green tests, locally green subsets, regenerated-but-not-reconciled vectors, or review rounds that have not reached the saturation rule are checkpoints only. They are **not** valid stopping or return points.
...
The definition of done is the merge/closure evidence in the main handoff, not the completion of any single phase or commit.